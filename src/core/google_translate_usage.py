"""Local estimate of Google Cloud Translation API character usage."""
...
USAGE_MONTH_KEY = "google_translate_usage_month"
USAGE_CHARS_KEY = "google_translate_usage_chars"


class GoogleTranslateUsage:
    """Track approximate source characters sent via Google Cloud Translation API."""
